...
//   return (
//     <div className={style.higscoreboard}>
//       <div className={style.gridHighScore}>
//         <table>
//           <thead>
//             <tr>
//               <th className={style.placement}>
//                 <h2>Place</h2>
//               </th>
//               <th className={style.player}>
//                 <h2>Player</h2>
//               </th>
//               <th className={style.score}>
//                 <h2>Score</h2>
//               </th>
//             </tr>
//           </thead>
...
//             {highScores.map((score, index) => (
//               <tr key={score.id}>
//                 <td className={style.playerPos}>{index + skipIndex0}</td>
//                 <td className={style.playerName}>{score.playerName}</td>
//                 <td className={style.playerScore}>{score.totalScore}</td>
//               </tr>
//             ))}
//           </tbody>
//         </table>
